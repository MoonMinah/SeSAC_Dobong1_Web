...
export function RefFunc1() {
  ...
  return (
    <>
      <p>버튼클릭시 input에 focus 처리 (useRef)</p>
...
export function RefFunc2() {
  ...
  return (
    <>
      ...
      <button onClick={plusStVariable}>state +1</button>
      <button onClick={plusVariable}>variablee +1</button>
    </>
  );
}
